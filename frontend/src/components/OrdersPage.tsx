  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        <div className="flex-1 p-6 overflow-y-auto absolute inset-0 pr-96">
          {!orderType && (
        ...
        {/* Right Section - Order Summary (Fixed header and footer) */}
        {(orderType === "takeaway" || (orderType === "dine-in" && selectedTable)) && (
          <div className="w-96 bg-white border-l border-gray-200 flex flex-col flex-shrink-0 absolute right-0 top-0 h-full">
            {/* Header - Fixed at top */}
